...
<div class="w-1/2 bg-amber-100 mr-5 rounded-3xl flex justify-center items-
center p-5 h-[500px]">
...
<h3 class="text-4xl font-light mb-3">Terima Kasih Sudah Mengisi Absen Dengan Jujur Absen {{ props.product.price }}</h3>
